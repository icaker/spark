...
import org.apache.spark.api.java.function.PathRecursive


private[streaming]
class FileInputDStreamRecur[K: ClassTag, V: ClassTag, F <: NewInputFormat[K,V] : ClassTag](
    @transient ssc_ : StreamingContext,
    directory: String,
    filter: Path => Boolean = FileInputDStreamRecur.defaultFilter,
  ...
  @transient private var pr_ : PathRecursive = null
...
*/
  ...
  //by limenghan
  private def pr: PathRecursive = {
    if (pr_ == null) pr_ = new PathRecursive()
    pr_
  }
